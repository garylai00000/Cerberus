  ...
  <div id="app-chat">
    <div class="online-list">
      <p v-for="onlinelist in onlinelists" style="height:35px;">
        <img class="online-user"  v-bind:src="'https://biggg.space:443/getavatar/' + onlinelist">
      </p>
    </div>
    <div class="message-container">
      <div v-for="message in sortedMessages">
      <div class="single-message">
        <img class="user-img"  v-bind:src="'https://biggg.space:443/getavatar/' + message.uid">
...
<script>
var socket = require('socket.io-client')('https://biggg.space:443');
